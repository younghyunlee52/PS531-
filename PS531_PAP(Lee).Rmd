...
```{r, data setting and data cleaning}
...
```{r, simple OLS and residual plot}
#simple regression
...
```{r, using declare design for my first model}
library(quantreg)
library(base)
#population
set.seed(1235)
...
```{r, declare design for my second test with the matched set}
set.seed(1111)
